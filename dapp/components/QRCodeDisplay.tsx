...
export function QRCodeDisplay({
  ...
  return (
    <div className={`flex flex-col items-center ${className}`}>
      ...
      {description && (
        <p className="text-sm text-foreground-muted mt-3 text-center max-w-xs">
          {description}
        </p>
      )}
      ...
      {showDownload && (
        <button
          ...
          className="mt-3 inline-flex items-center gap-2 px-4 py-2 bg-surface-recessed hover:bg-border text-foreground-muted rounded-lg transition-colors text-sm"
        >
